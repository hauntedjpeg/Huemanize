// @ts-nocheck — vendored third-party code; see attribution below.
//
// Vendored from radix-ui/website: components/generateRadixColors.tsx
// https://github.com/radix-ui/website/blob/main/components/generateRadixColors.tsx
// Original (c) Radix UI authors, MIT License.
// Modifications: file extension renamed .tsx -> .ts (no JSX present);
// @ts-nocheck added to skip strict-null-check noise in colorjs.io's `Coords`
// type (`number | null`), which the algorithm treats as `number` in practice.
// See ./__vendor__.md for re-vendoring notes.
